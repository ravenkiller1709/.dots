...
I am using the [[https://github.com/tonsky/FiraKode][Fira Code]] and [[https://fonts.google.com/specimen/Cantarell][Cantarell]] fonts for this configuration which will more than likely need to be installed on your machine.  Both can usually be found in the various Linux distro package managers or downloaded from the links above.
...
* Dashboard
Start Emacs with a dashboard with links to recent files
#+begin_src emacs-lisp
