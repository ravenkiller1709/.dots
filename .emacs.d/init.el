...
(use-package org
  ...
  (setq org-todo-keywords
    '((sequence "TODO(t)" "PLANNED(n)" "|" "DONE(d!)")
  ...
  (setq org-agenda-custom-commands
   '(("d" "Dashboard"
    ...
    ("e" tags-todo "+TODO=\"PLANNED\"+Effort<15&+Effort>0"
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(sqlite3 forge magit vterm mu4e-alert nerd-icons-ivy-rich treemacs visual-fill-column which-key use-package org-bullets no-littering ivy-rich ivy-prescient doom-themes doom-modeline counsel all-the-icons)))
(custom-set-faces
