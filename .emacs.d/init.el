  ...
  (setq org-capture-templates
    `(("t" "Tasks / Projekter")
      ...
      ("jj" "Journal" entry
           ...
           ;; ,(dw/read-file-as-string "~/Noter/Templates/Daily.org")
           :clock-in :clock-resume
           :empty-lines 1)
      ("jm" "Meeting" entry
           (file+olp+datetree "~/Projekter/Kode/Journal.org")
           "* %<%I:%M %p> - %a :meetings:\n\n%?\n\n"
           :clock-in :clock-resume
           :empty-lines 1)
...
(use-package dashboard
  ...
  (progn
    ...
    (setq dashboard-banner-logo-title "Kim Kruse's Emacs")
    (setq dashboard-startup-banner "~/Billeder/IMG_3958lille.png")
...
(use-package projectile
  ...
  (when (file-directory-p "~/Projekter/Kode")
    (setq projectile-project-search-path '("~/Projekter/Kode")))
...
(use-package gptel
   :config
   (setq gptel-api-key "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"))
