;;; emms-player-simple-mpv-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
Clear tq-enque if it remains." t nil)
...
Display position in current file." t nil)

(autoload 'emms-player-simple-mpv-time-pos-% "emms-player-simple-mpv-control-functions" "\
Display position (0-100) in current file." t nil)
...
Display current position on the playlist." t nil)
...
Display title of the current entry." t nil)
...
Display title current entry." t nil)
