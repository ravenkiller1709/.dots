...
(custom-set-variables
 ...
 '(package-selected-packages
   '(auto-complete counsel swiper lorem-ipsum ace-window try dracula-theme darcula-theme vterm exwm dired-hide-dotfiles dired-open all-the-icons-dired dired-single eshell-git-prompt visual-fill-column org-bullets hydra orderless vertico doom-modeline doom-themes magit auto-package-update use-package)))
(custom-set-faces
