...
(setq exwm-input-global-keys
	  ...
	  (,(kbd "s-M-<left>") . windmove-swap-states-left)
	  (,(kbd "s-M-<right>") . windmove-swap-states-right)
	  (,(kbd "s-M-<up>") . windmove-swap-states-up)
	  (,(kbd "s-M-<down>") . windmove-swap-states-down)

	  ;; start multi-vterm
	  (,(kbd "C-M-t") . multi-vterm)
	...
	([?\M-m] . (lambda ()
		     (interactive)
		     (start-process "" nil "/home/kim/.scripts/sb-mailbox")))
...
;; Rebind CapsLock to Ctrl
  (start-process-shell-command "xmodmap" nil "xmodmap ~/.dots/emacs/Xmodmap")
...
;; display worspace number in modeline
